...
dicts = {"1": "a", "2": "b", "3": "c", "4": "d", "5": "e"}
keys = list(dicts.keys())
print(dicts.keys())
print("1" in dicts.keys())
print("2" in dicts.keys())
print("3" in dicts.keys())
print("4" in dicts.keys())
print("5" in dicts.keys())
print("6" in dicts.keys())
